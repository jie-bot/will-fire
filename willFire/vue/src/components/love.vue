  ...
  <div>
    ...
    <div class="bg-wrap my-animation-slide-top">
      ...
      <el-image class="love-image my-el-image"
                lazy
                :src="$store.state.sysConfig['webStaticResourcePrefix'] + 'assets/love-bgc.png'"
                fit="cover">
  ...
  export default {
    ...
    methods: {
      ...
      submitLove() {
        ...
        this.$http.post("http://47.96.86.223:8081/api" + "/family/saveFamily", this.userLove)
          .then((res) => {
            this.$message({
              type: 'success',
              message: '提交成功，待管理员审核！'
      ...
      addFamily() {
        ...
        this.$http.get("http://47.96.86.223:8081/api" + "/family/getFamily")
          .then((res) => {
      ...
      getPhotoTitles() {
        this.$http.get("http://47.96.86.223:8081/api" + "/webInfo/listAdminLovePhoto")
          .then((res) => {
            if (!this.$common.isEmpty(res.data)) {
      ...
      getAdminFamily() {
        this.$http.get("http://47.96.86.223:8081/api" + "/family/getAdminFamily")
          .then((res) => {
            if (!this.$common.isEmpty(res.data)) {
              this.love = res.data;
      ...
      getRandomFamily() {
        this.$http.get("http://47.96.86.223:8081/api" + "/family/listRandomFamily")
          .then((res) => {
            if (!this.$common.isEmpty(res.data)) {
      ...
      changePhoto() {
        this.$http.post("http://47.96.86.223:8081/api" + "/webInfo/listResourcePath", this.photoPagination)
          .then((res) => {
            if (!this.$common.isEmpty(res.data)) {
      ...
      getWeiYan() {
        this.$http.post("http://47.96.86.223:8081/api" + "/weiYan/listWeiYan", this.weiYanPagination)
          .then((res) => {
            if (!this.$common.isEmpty(res.data)) {
