...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goAdmin() {
        // alert(this.$constant.webURL);
        window.open(this.$constant.webURL + "/admin");
      },

      logout() {
        this.$http.get("http://47.96.86.223:8081/api" + "/user/logout")
          .then((res) => {
          })
          .catch((error) => {
            this.$message({
      ...
      getWebInfo() {
        this.$http.get("http://47.96.86.223:8081/api" + "/webInfo/getWebInfo")
          .then((res) => {
      ...
      getSysConfig() {
        this.$http.get("http://47.96.86.223:8081/api" + "/sysConfig/listSysConfig")
          .then((res) => {
            if (!this.$common.isEmpty(res.data)) {
      ...
      buildCssPicture() {
        ...
        root.style.setProperty("--bannerWave1", "url(" + "../assets/bnv1.jpg) repeat-x");
        root.style.setProperty("--bannerWave2", "url(" + "../assets/bnv2.jpg) repeat-x");
        ...
        // const font = new FontFace("poetize-font", "url(" + webStaticResourcePrefix + "fonts/fontawesome-webfont.woff2)");
        // font.load();
        // document.fonts.add(font);
      },
      getSortInfo() {
        this.$http.get("http://47.96.86.223:8081/api" + "/webInfo/getSortInfo")
          .then((res) => {
            if (!this.$common.isEmpty(res.data)) {
