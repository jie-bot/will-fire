  ...
  export default {
    ...
    methods: {
      ...
      login() {
        ...
        this.$http.post("http://47.96.86.223:8081/api" + "/user/login", user, false, false)
          .then((res) => {
      ...
      regist() {
        ...
        this.$http.post("http://47.96.86.223:8081/api" + "/user/regist", user)
          .then((res) => {
            if (!this.$common.isEmpty(res.data)) {
              this.$store.commit("loadCurrentUser", res.data);
              localStorage.setItem("userToken", res.data.accessToken);
      ...
      submitUserInfo() {
        ...
        this.$confirm('确认保存？', '提示', {
          ...
          this.$http.post("http://47.96.86.223:8081/api" + "/user/updateUserInfo", user)
            .then((res) => {
              if (!this.$common.isEmpty(res.data)) {
                this.$store.commit("loadCurrentUser", res.data);
      ...
      updateSecretInfo() {
        ...
        if (this.dialogTitle === "找回密码") {
          this.$http.post("http://47.96.86.223:8081/api" + "/user/updateForForgetPassword", params, false, false)
            .then((res) => {
              this.clearDialog();
              this.$message({
                message: "修改成功，请重新登陆！",
          ...
          this.$http.post("http://47.96.86.223:8081/api" + "/user/updateSecretInfo", params, false, false)
            .then((res) => {
              if (!this.$common.isEmpty(res.data)) {
                this.$store.commit("loadCurrentUser", res.data);
                this.currentUser = this.$store.state.currentUser;
      ...
      getCode() {
        if (this.codeString === "验证码") {
          ...
          this.$http.get("http://47.96.86.223:8081/api" + url, params)
            .then((res) => {
              this.$message({
