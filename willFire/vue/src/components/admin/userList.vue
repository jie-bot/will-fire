...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getUsers() {
        this.$http.post("http://47.96.86.223:8081/api" + "/admin/user/list", this.pagination, true)
          .then((res) => {
      ...
      changeUserStatus(user) {
        this.$http.get("http://47.96.86.223:8081/api" + "/admin/user/changeUserStatus", {
          userId: user.id,
      ...
      changeUserAdmire(user) {
        if (!this.$common.isEmpty(user.admire)) {
          this.$confirm('确认保存？', '提示', {
            ...
            this.$http.get("http://47.96.86.223:8081/api" + "/admin/user/changeUserAdmire", {
              userId: user.id,
              admire: user.admire
            }, true)
              .then((res) => {
      ...
      saveEdit() {
        this.$http.get("http://47.96.86.223:8081/api" + "/admin/user/changeUserType", {
