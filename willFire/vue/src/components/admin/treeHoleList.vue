...
<script>
  ...
  export default {
    ...
    methods: {
      getTreeHoles() {
        this.$http.post("http://47.96.86.223:8081/api" + "/admin/treeHole/boss/list", this.pagination, true)
          .then((res) => {
      ...
      handleDelete(item) {
        this.$confirm('确认删除？', '提示', {
          ...
          this.$http.get("http://47.96.86.223:8081/api" + "/webInfo/deleteTreeHole", {id: item.id}, true)
            .then((res) => {
