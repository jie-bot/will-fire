  ...
  export default {
    ...
    methods: {
      ...
      addResourcePath() {
        ...
        this.$http.post("http://47.96.86.223:8081/api" + "/webInfo/" + (this.isUpdate ? "updateResourcePath" : "saveResourcePath"), this.resourcePath, true)
          .then((res) => {
            this.$message({
              message: "保存成功！",
              type: "success"
      ...
      getResourcePaths() {
        this.$http.post("http://47.96.86.223:8081/api" + "/webInfo/listResourcePath", this.pagination, true)
          .then((res) => {
      ...
      changeStatus(item) {
        this.$http.post("http://47.96.86.223:8081/api" + "/webInfo/updateResourcePath", item, true)
          .then((res) => {
            this.$message({
              message: "修改成功！",
              type: "success"
      ...
      handleDelete(item) {
        this.$confirm('确认删除？', '提示', {
          ...
          this.$http.get("http://47.96.86.223:8081/api" + "/webInfo/deleteResourcePath", {id: item.id}, true)
            .then((res) => {
              this.search();
              this.$message({
                message: "删除成功！",
