  ...
  export default {
    ...
    methods: {
      ...
      changeWebStatus(webInfo) {
        this.$http.post("http://47.96.86.223:8081/api" + "/webInfo/updateWebInfo", {
          id: webInfo.id,
      ...
      getWebInfo() {
        this.$http.get("http://47.96.86.223:8081/api" + "/admin/webInfo/getAdminWebInfo", {}, true)
          .then((res) => {
      ...
      updateWebInfo(value) {
        this.$confirm('确认保存？', '提示', {
          ...
          this.$http.post("http://47.96.86.223:8081/api" + "/webInfo/updateWebInfo", value, true)
            .then((res) => {
              this.getWebInfo();
              this.$message({
                message: "保存成功！",
