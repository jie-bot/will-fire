    ...
    methods: {
      deleteHandle(id, flag) {
        ...
        this.$confirm('确认删除？', '提示', {
          ...
          this.$http.get("http://47.96.86.223:8081/api" + url, {id: id}, true)
            .then((res) => {
              this.$message({
                message: "删除成功！",
                type: "success"
      ...
      saveSortEdit() {
        ...
        this.$http.post("http://47.96.86.223:8081/api" + url, this.sortForHttp, true)
          .then((res) => {
            this.$message({
              message: "保存成功！",
              type: "success"
      ...
      saveLabelEdit() {
        ...
        this.$http.post("http://47.96.86.223:8081/api" + url, this.labelForHttp, true)
          .then((res) => {
            this.$message({
              message: "保存成功！",
              type: "success"
