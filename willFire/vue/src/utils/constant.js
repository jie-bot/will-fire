export default {
  // 测试环境
  // baseURL: "http://47.96.86.223:8081/api",
  ...
  //前后端定义的密钥，AES使用16位
  cryptojs_key: "firefirefirefire",

  friendWebName: "火の意志",
  friendUrl: location.protocol + "//" + location.hostname + (location.port ? ':' + location.port : ''),
  friendAvatar: "http://si7o900bp.hn-bkt.clouddn.com/c50561325d3f9ad4019bfbee14849a4.jpg",
  friendIntroduction: "这是一个 Vue2 Vue3 与 SpringBoot 结合的产物～",
  friendCover: "http://si7o900bp.hn-bkt.clouddn.com/%E5%B1%8F%E5%B9%95%E6%88%AA%E5%9B%BE%202024-08-18%20150944.png",
