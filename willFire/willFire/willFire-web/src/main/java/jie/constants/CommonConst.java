package jie.constants;

/**
 * @version 1.0
 * @Author jie
 * @Date 2024/8/12 下午9:56
 * @注释 常量
 */
public class CommonConst {
     ...
     * 密钥
     */
    public static final String CRYPOTJS_KEY = "firefirefirefire";
     ...
     * 文件上传类
     */
    public static final String FILE_OSS = "qiniu";
    public static final String MIN_IO = "local";
    public static String defaultStoreType = FILE_OSS;
}
